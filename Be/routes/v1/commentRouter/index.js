...
CommentRouter.get("/", middlewares.verifyAccessToken, middlewares.validateAdmin, commentController.getAllComment); // Lấy tất cả bình luận - ADMIN
CommentRouter.get("/countCommentsByNews/:newsId", middlewares.verifyAccessToken, middlewares.validateAdmin, commentController.countCommentsByNews); // Đếm tất cả bình luận và theo trạng thái theo tin - ADMIN
CommentRouter.get("/commentByNewsId", commentController.getCommentByNewsId); // Lấy tất cả bình luận theo tin tức - ALL
