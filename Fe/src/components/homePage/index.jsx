    ...
    return (
        <div className='homePage'>
            ...
            <section className='section2'>
                <h1>Về chúng tôi</h1>
                <p>Chúng tôi tự hào là một trong những hệ thống bán xe chuyên nghiệp và uy tín hàng đầu tại Việt Nam</p>
                ...
                <div className='howItWorks'>
                    ...
                    <div className='right'>
                        <div className='withCustomer'>
                            ...
                            <div className='item'>
                                <h4>1, Đăng ký:</h4>
                                <p>Hãy đăng ký 1 tài khoản để bắt đầu sử dụng các dịch vụ của chúng tôi</p>
                            </div>
                            <div className='item'>
                                <h4>2, Tìm kiếm:</h4>
                        ...
                        <div className='withPartner'>
                            ...
                            <div className='item'>
                                <i>*Đặc biệt, đối tác có thể gửi xe ở các cơ sở của chúng tôi, chúng tôi sẽ thực hiện nhận lịch và tiếp đón khách hàng thay cho đối tác*</i>
                            </div>
                        </div>
                    </div>
                </div>
