...
const ListCarsByState = () => {
    ...
    const queryCountCars = async () => {
        try {
            const response = await axios.get(`https://car-selling-web.onrender.com/api/v1/cars/countCarsByState/${splitPathname[5]}`,
                {
                    headers: {
    ...
    const queryListCars = async () => {
        try {
            const response = await axios.get(`https://car-selling-web.onrender.com/api/v1/cars/carByState?limit=${limit}&currentPage=${currentPage}&isStatus=${isStatus}&state=${splitPathname[5]}`,
                {
                    headers: {
                        'Authorization': `Bearer ${accessToken}`,
                    },
